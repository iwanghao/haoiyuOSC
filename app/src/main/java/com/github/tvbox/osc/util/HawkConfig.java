...
public class HawkConfig {
    public static final String API_URL = "api_url"; //配置地址
    public static final String EPG_URL = "epg_url"; //电视地址
    public static final String SHOW_PREVIEW = "show_preview"; //显示预览
